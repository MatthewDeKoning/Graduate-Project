...
A = 1  #td14 coefficient
B = 1  #td23 coefficient
#treat the last few like tests, the first few like training
...
for file in files:
    ...
    mode = 0#set to 0 if file.split("_")[0] == S, 1 if T
    if file.split("_")[0] == 'T':
        mode = 1
    ...
    def velocity_est():
          ...
          return (avg_time_1, avg_time_2, avg_time_3, avg_time_4);
          '''
          time_difference_1_4 = A*abs(avg_time_4 - avg_time_1)
          time_difference_2_3 = B*abs(avg_time_3 - avg_time_2)
          #return (time_difference_1_4, time_difference_2_3)
          ...
          if time_difference_1_4 != 0 and time_difference_2_3 != 0:
             ...
             if difference_coefficient != 0:
                ...
                if distance_estimate < 20:
                    distance_estimate = 20
                elif distance_estimate > 30:
                    distance_estimate = 30
...
#fix times
    ...
    #estimate velocity
    (t1, t2, t3, t4) = velocity_est()
    #w = estimate_width(s)
    #s = s*0.681818 #convert to mph
    #(a14, a23) = sim2.test_func(mode, actual_s*1.46667, actual_d, 17)
    print file
    print t1, t2, t3, t4
